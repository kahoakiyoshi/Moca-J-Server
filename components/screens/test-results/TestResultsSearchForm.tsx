...
interface TestResultsSearchFormProps {
  initialFilters: TestResultsFilters;
  onSearch: (data: TestResultsFilters) => void;
  onClear: () => void;
}

export const TestResultsSearchForm: React.FC<TestResultsSearchFormProps> = ({
  initialFilters,
  onSearch,
  onClear,
}) => {
