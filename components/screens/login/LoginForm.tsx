    ...
    <form id="login-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-1">
        ...
        <Input
          ...
          className={`border-neutral-200 bg-white focus:border-[#3f65b8] focus:ring-[#3f65b8]/20 ${errors.email ? "border-red-500" : ""}`}
        />
        {errors.email && (
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          <Input
            ...
            {...register("password")}
            disabled={isSubmitting}
            className={`border-neutral-200 bg-white pr-10 focus:border-[#3f65b8] focus:ring-[#3f65b8]/20 ${errors.password ? "border-red-500" : ""}`}
          />
          <button
            type="button"
