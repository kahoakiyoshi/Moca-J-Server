...
export const alls_test: Record<string, string> = {
  "node_test": "Trail Making",
  "node_test_sequence": "Trail Making",
  "drawing_test": "視空間認知機能 立方体描画",
  ...
  "clock_validation": "視空間認知機能 時計 文字と針選択",
  "clock_validation_step_1": "視空間認知機能 時計 文字と針選択",
  "clock_validation_step_2": "視空間認知機能 時計 文字と針選択",
  "clock_validation_step_3": "視空間認知機能 時計 文字と針選択",
  "clock_validation_step_4": "視空間認知機能 時計 文字と針選択",
  "naming_task": "命名 設問",
  "naming_task_animal_1": "命名 設問1",
  "naming_task_animal_2": "命名 設問2",
  "naming_task_animal_3": "命名 設問3",
  "word_recall": "記憶 試行1回目",
