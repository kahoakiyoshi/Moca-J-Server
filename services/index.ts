...
export const patientService = {
  getPatients: async (params?: { page?: number; limit?: number; id?: string; searchName?: string }): Promise<{ patients: Patient[]; totalCount: number }> => {
...
export const testResultService = {
  ...
  getTestResultDetail: async (id: string): Promise<{ testResult: TestResult; patient: Patient | null }> => {
